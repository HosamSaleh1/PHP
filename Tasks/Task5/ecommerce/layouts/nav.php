                ...
                <div class="col-lg-9 col-md-8 col-6">
                    <div class="header-bottom-right">
                                    ...
                                    <li class="mega-menu-position top-hover"><a href="shop.php">Categories</a>
                                        <ul class="mega-menu">
                                            ...
                                            ?>
                                                    <li>
                                                        <ul>
                                                            <li class="mega-menu-title"><a style="font-size: 20px !important;font-weight: bold;" href="shop.php?cat=<?= $category['id'] ?>"><?= $category['name_en'] ?></a></li>
                        ...
                        <div class="header-currency">
                            ...
                            ?>
                                <a href="login.php" class="digit">Login <i class="ti-angle-down"></i></a>
                                <div class="dollar-submenu">
                                    <ul>
